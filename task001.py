...
input_words = input('Введи свой стих: ')
st = input_words.lower().split()
def function_rhythm(x): return sum(1 for i in x if i in 'аеёиоуыэюя')


t = function_rhythm(st[0])
if all([function_rhythm(i) == t for i in st]):
    print('Парам пам-пам')
else:
    print('Пам парам')
